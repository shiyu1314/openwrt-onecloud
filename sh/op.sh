...
git clone -b main --depth 1 --single-branch https://github.com/xiaorouji/openwrt-passwall-packages package/openwrt-passwall
git clone -b v5-lua --depth 1 --single-branch https://github.com/sbwml/luci-app-mosdns package/luci-app-mosdns
git clone -b main --depth 1 --single-branch https://github.com/xiaorouji/openwrt-passwall package/passwall
...
sed -i 's|https://github.com|https://gh.api.99988866.xyz/https://github.com|g' feeds/mihomo/luci-app-mihomo/htdocs/luci-static/resources/view/mihomo/mixin.js
sed -i 's|https://github.com|https://gh.api.99988866.xyz/https://github.com|g' feeds/mihomo/mihomo/files/mihomo.conf
