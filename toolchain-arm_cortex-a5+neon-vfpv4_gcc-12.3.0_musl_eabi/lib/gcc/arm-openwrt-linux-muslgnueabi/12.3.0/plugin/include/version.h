...
BASEVER,, DEVPHASE, and REVISION are defined by the
Makefile.  */

#define version_string "12.3.0"
#define pkgversion_string "(OpenWrt GCC 12.3.0 r24147-b551214c9d) "
...
#define bug_report_url "<http://bugs.openwrt.org/>"
